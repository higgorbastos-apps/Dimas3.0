...
export default function App() {
  ...
  const saveProfile = useCallback(async (p, isFirst) => {
    ...
    if (isFirst) {
      await sendMessage(
        "Apresentação inicial: acabei de receber seu briefing completo. Apresente-se profissionalmente e faça uma análise honesta do meu perfil — potencial real, o que me limita agora e a primeira ação concreta desta semana.",
        []
      );
    }
  }, [sendMessage]);
